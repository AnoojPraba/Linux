...
int main()
{
    ...
    cout << "Bad circle area: " << areaBad(circleData) << endl;
    cout << "Bad rectangle area: " << areaBad(rectData) << endl;

    vector<unique_ptr<Shape>> shapes;
    shapes.push_back(make_unique<Circle>(CIRCLE_RADIUS));
    shapes.push_back(make_unique<Rectangle>(RECTANGLE_WIDTH, RECTANGLE_HEIGHT));
