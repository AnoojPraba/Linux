...
int main()
{
    ...
    std::cout << "map lookups took "
              << std::chrono::duration_cast<std::chrono::microseconds>(mapEnd - mapStart).count()
              << " us (sum=" << mapSum << ")\n";
    std::cout << "unordered_map lookups took "
